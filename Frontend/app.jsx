  ...
  return (
    <div className={shellClasses}>
      ...
      <main className="relative z-10 mx-auto mt-24 w-[calc(100%-1rem)] max-w-[1200px] pb-16 md:mt-28 md:w-[calc(100%-2rem)] md:pb-20">
        ...
        <section id="about" className={`mt-14 grid gap-6 p-7 text-center md:grid-cols-2 md:p-10 ${panelClasses}`}>
          <div>
      ...
      <footer className={`relative z-10 mt-16 w-full px-6 pb-8 pt-10 text-sm shadow-[0_14px_36px_rgba(31,49,71,0.08)] ${panelClasses}`}>
