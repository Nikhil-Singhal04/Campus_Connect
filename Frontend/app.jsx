function App() {
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[linear-gradient(130deg,#070d20,#0f1c3a)]">
      ...
      <header className="relative z-10 mx-auto mt-4 flex w-[calc(100%-1rem)] max-w-[1200px] items-center justify-between py-3 md:mt-6 md:w-[calc(100%-2rem)]">
        <a href="index.html" aria-label="Campus Connect Home" className="inline-flex shrink-0">
          <img src="campus-connect-logo.svg" alt="Campus Connect" className="h-20 w-auto md:h-24" />
        </a>
      ...
      <main className="relative z-10 mx-auto mt-10 flex min-h-[44vh] w-[calc(100%-1rem)] max-w-[1080px] items-center justify-center pb-16 md:mt-14 md:w-[calc(100%-2rem)] md:pb-20">
